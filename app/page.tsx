...
export default function Home() {
  return <>
    <header className="site-header"><Link href="/" className="brand"><span className="brand-mark">s/</span>student<span>.codes</span></Link><nav><a href="#paths">Paths</a><a href="#resources">Resources</a><a href="#roadmap">How it works</a><a href="#community">Community</a></nav><div className="header-actions"><a className="icon-link" href="https://github.com/realjackhalder/student.codes" aria-label="GitHub"><Github size={18} /></a><a href="#resources" className="button small">Start exploring <ArrowRight size={15} /></a><button className="menu" aria-label="Open menu"><Menu /></button></div></header>
    ...
    <footer><Link href="/" className="brand"><span className="brand-mark">s/</span>student<span>.codes</span></Link><p>Code, ICT, and AI learning for every curious student.</p><div><a href="#paths">Paths</a><a href="#resources">Resources</a><a href="https://github.com/realjackhalder/student.codes">GitHub</a></div><small>© {new Date().getFullYear()} student.codes</small></footer>
  </>;
}
